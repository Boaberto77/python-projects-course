...
def is_palindrome(string):
	# Remove the spaces and convert to lowercase and strip notation
	'''
	cleaned_string = ''
	# Loop through our user input
	for character in string:
		# Check to see if the character is a character
...
user_input = input("Enter a Word or phrase to check if its a palindrome: ")
